...
| `test_sekil_esik.py` | delik şekil kapısı eşikleri nokta başına: hilal sentetik ROI → 'sekil uygun degil' + '<' işareti, override → OK, genel eşik → OK, başka nokta etkilemez, kategori; editör alanları (0-1, 2 ondalık); `_open_roi_manager` roi_defaults |
